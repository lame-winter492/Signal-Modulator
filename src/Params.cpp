...
PF_Err AddParams(PF_InData* in_data, PF_OutData* out_data) {
    ...
    PF_ADD_CHECKBOX("CH1", "Enable channel 1", 0, 0, SM_CH1);
    PF_ADD_CHECKBOX("CH2", "Enable channel 2", 0, 0, SM_CH2);
    PF_ADD_CHECKBOX("CH3", "Enable channel 3", 0, 0, SM_CH3);
    PF_ADD_CHECKBOX("CH4", "Enable channel 4", 0, 0, SM_CH4);
